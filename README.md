...
| | | | | |
|:---:|:---:|:---:|:---:|:---:|
| <img src="https://REPLACE_WITH_IMAGE_URL/max_euceda.jpg" width="120" height="120" style="border-radius:50%;object-fit:cover" alt="Max Euceda"/> | <img src="https://REPLACE_WITH_IMAGE_URL/jeet_selal.jpg" width="120" height="120" style="border-radius:50%;object-fit:cover" alt="Jeet Selal"/> | <img src="https://REPLACE_WITH_IMAGE_URL/saket_gokhle.jpg" width="120" height="120" style="border-radius:50%;object-fit:cover" alt="Saket Gokhle"/> | <img src="https://REPLACE_WITH_IMAGE_URL/jeff_nippard.jpg" width="120" height="120" style="border-radius:50%;object-fit:cover" alt="Jeff Nippard"/> | <img src="https://REPLACE_WITH_IMAGE_URL/yatinder_singh.jpg" width="120" height="120" style="border-radius:50%;object-fit:cover" alt="Yatinder Singh"/> |
| **[Max Euceda](https://www.youtube.com/@MaxEuceda)** | **[Jeet Selal](https://www.youtube.com/@JeetSelal)** | **[Saket Gokhle](https://www.youtube.com/@SaketGokhle)** | **[Jeff Nippard](https://www.youtube.com/@JeffNippard)** | **[Yatinder Singh](https://www.youtube.com/@YatinderSingh)** |
...
> 📸 **Note:** Replace `REPLACE_WITH_IMAGE_URL/filename.jpg` with actual image paths — either hosted online or placed in the repo root/assets folder. Example: `./assets/max_euceda.jpg`
